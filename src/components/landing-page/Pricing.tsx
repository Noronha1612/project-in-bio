			...
			<div className='flex items-end gap-9'>
				<div className='flex w-[304px] flex-col gap-7 rounded-2xl border border-[#1E1E1E] p-8'>
					<div className='flex flex-col'>
						...
						<span className='text-content-body'>Anual</span>
					</div>
				...
				<div className='flex flex-col'>
					...
					<div className='w-[304px] rounded-b-2xl bg-[linear-gradient(90deg,#4B2DBB_0%,#B5446B_100%)] p-[1.6px]'>
						<div className='bg-background-secondary flex w-full flex-col gap-7 rounded-b-2xl p-8'>
							<div className='flex flex-col'>
								<span className='text-2xl font-bold text-white'>Vitálicio</span>
								<span className='text-content-body'>Economize com</span>
							</div>

							<span className='text-[48px] font-bold text-white'>R$ 99,90</span>
